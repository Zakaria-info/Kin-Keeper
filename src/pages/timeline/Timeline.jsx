      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <select
            ...
            className="select select-bordered w-full max-w-xs bg-white border-gray-200 text-[#64748B] focus:outline-none"
          >
        ...
        <div className="flex flex-col gap-4">
          {filteredData.map((item) => (
            <div
              key={item.id}
              className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm flex items-center gap-5 transition-all hover:shadow-md"
            >
            ...
            <div className="text-center py-20 bg-white rounded-2xl border border-dashed border-gray-300">
              <p className="text-gray-400">
                {timelineData.length === 0
                  ? "No interactions logged yet. Go to a Friend's page to check-in!"
